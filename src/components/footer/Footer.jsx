            ...
            <div className="col-12 col-md-12 col-lg-8">
              <div className="row g-4">
                <div className="col-6 col-sm-6 col-md-3">
                  <h6 className="mb-3">Get to know us</h6>
                ...
                <div className="col-6 col-sm-6 col-md-3">
                  <h6 className="mb-3">For Consumers</h6>
                  <ul>
                    <li>
                      <a href="#!" className="nav-link">
                        Payments
                ...
                <div className="col-6 col-sm-6 col-md-3">
                  <h6 className="mb-3">Become a Shopper</h6>
                  <ul>
                    <li>
                      <a href="#!" className="nav-link">
                ...
                <div className="col-6 col-sm-6 col-md-3">
                  <h6 className="mb-3">Freshcart programs</h6>
                  <ul>
                    <li>
                      <a href="#!" className="nav-link">
                        Freshcart programs
              ...
              <div className="col-lg-5 text-lg-start text-center mb-2 mb-lg-0">
                <ul className="list-inline mb-0">
                  ...
                  <li className="list-inline-item">
                    <a href="#!">
                      <img src="/images/icons/amazonpay.svg" alt="" />
                    </a>
                  </li>
                  <li className="list-inline-item">
                    <a href="#!">
              ...
              <div className="col-lg-7 mt-4 mt-md-0">
                <ul className="list-inline mb-0 text-lg-end text-center">
                  <li className="list-inline-item mb-2 mb-md-0 text-dark">
                    Get deliveries with Sannibh
                  </li>
                  <li className="list-inline-item ms-4">
                    <a href="#!">
                      <img src="/images/icons/appstore-btn.svg" alt="" />
                    </a>
                  </li>
                  <li className="list-inline-item">
                    <a href="#!">
                      <img src="/images/icons/googleplay-btn.svg" alt="" />
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <div className="row align-items-center">
              <div className="col-md-6">
                <span className="small text-muted">
                  ...
                  Sannibh eCommerce HTML Template. All rights reserved.
                </span>
              </div>
              <div className="col-md-6">
